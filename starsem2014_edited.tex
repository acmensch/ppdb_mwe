...
\hline \bf Light verb & \bf Number of  & \bf Number  & \bf Example matches, and their paraphrases\\ 
 & \bf verb phrases & \bf manually categorized & \\ 
...
We used an SVM classifier (libsvm) with these features on our sample of 500 words from the PPDB L corpus. With ten-fold cross-validation, the accuracy of the classifier was 76.4\%. This improves beyond the majority class baseline by 7.2\% absolute / 10.4\% relative.
